...
@Tag(name = "병원 검색 API", description = "사용자 위치 기반으로 병원을 검색합니다.")
public class HospitalController {
  ...
  @PostMapping("/search")
  @Operation(
          summary = "반경 1km 이내 병원 검색",
          description = "사용자의 위도, 경도, 언어 정보를 바탕으로 반경 1km 내의 병원 정보를 반환합니다."
  )
  public List<HospitalLocResponseDto> getNearbyHospitals(
          @RequestBody HospitalLocRequestDto dto
  ) {

    List<HospitalLocResponseDto> ret = hospitalService.findHospitalsNearby(dto.latitude(), dto.longitude());
