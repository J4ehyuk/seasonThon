...
public class AiClient {
  ...
  public AiPredictionResult analyzePrompt(String prompt) {
    ...
    String systemPrompt = """
              ...
              [가정의학과, 구강내과, 구강병리과, 구강악안면외과, 기타, 내과, 마취통증의학과, 산부인과, 사상체질과, 소아과, 소아청소년과, 성형외과, 소아치과, 신경과, 신경외과, 심장혈관흉부외과, 영상치의학과, 예방치과, 외과, 이비인후과, 일반의, 재활의학과, 정신건강의학과, 정형외과, 치과교정과, 치과보존과, 치과보철과, 치주과, 통합치의학과, 피부과, 한방내과, 한방부인과, 한방소아과, 한방신경정신과, 한방안·이비인후·피부과, 한방재활의학과, 한방응급, 안과]
